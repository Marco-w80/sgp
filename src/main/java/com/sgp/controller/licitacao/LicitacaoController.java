...
public class LicitacaoController {
    ...
    @PostMapping("/{id}/anexos") public String upload(@PathVariable Long id,@RequestParam MultipartFile arquivo,@RequestParam(required=false)Long itemId,@RequestParam(required=false)EtapaLicitacao etapa,RedirectAttributes ra)throws IOException{anexos.salvar(id,itemId,etapa,arquivo);ra.addFlashAttribute("mensagem","Arquivo anexado.");return detalhe(id,"anexos");}
