...
public class PortfolioController {
    ...
    @PostMapping("/fornecedores") public String fornecedor(@RequestParam(required=false)Long id,@RequestParam(required=false)String cnpj,@RequestParam String nome,@RequestParam(required=false)String contato,@RequestParam(required=false)String resumo,@RequestParam(required=false)String observacoes,RedirectAttributes ra){service.salvarFornecedor(id,cnpj,nome,contato,resumo,observacoes);ra.addFlashAttribute("mensagem","Fornecedor salvo.");return redirect("fornecedores");}
